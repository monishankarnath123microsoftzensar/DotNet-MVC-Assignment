...
using WebAppProductWithDatabaseFirst;

namespace WebAppProductWithDatabaseFirst.Controllers
{
    public class ProductTblsController : Controller
    {
        private DotNetWebAppEntities db = new DotNetWebAppEntities();

        // GET: ProductTbls
        public ActionResult Index()
        {
            var productTbls = db.ProductTbls.Include(p => p.BookTbl);
        ...
        {
            ViewBag.BookId = new SelectList(db.BookTbls, "BookId", "BookName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "PId,PName,PRate,BookId")] ProductTbl productTbl)
        {
            ...
            ViewBag.BookId = new SelectList(db.BookTbls, "BookId", "BookName", productTbl.BookId);
            return View(productTbl);
        }
